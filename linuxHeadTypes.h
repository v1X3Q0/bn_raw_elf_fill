...
enum e_type : uint16_t
{
	...
	ET_LOOS = 65024, /* OS-specific range start */
	ET_HIOS = 65279, /* OS-specific range end */
	ET_LOPROC = 65280, /* Processor-specific range start */
	ET_HIPROC = 65535, /* Processor-specific range end */
};
...
typedef struct
{
  struct Elf_Ident e_ident;	/* Magic number and other info */
  enum e_type	e_type;			/* Object file type */
  enum e_machine	e_machine;		/* Architecture */
...
enum sh_type : uint32_t
{
	...
	SHT_LOOS = 1610612736, /* Start OS-specific.  */
	SHT_GNU_ATTRIBUTES = 1879048181, /* Object attributes.  */
	SHT_GNU_HASH = 1879048182, /* GNU-style hash table.  */
	SHT_GNU_LIBLIST = 1879048183, /* Prelink library list */
	SHT_CHECKSUM = 1879048184, /* Checksum for DSO content.  */
	SHT_LOSUNW = 1879048186, /* Sun-specific low bound.  */
	SHT_SUNW_move = 1879048186, 
	SHT_SUNW_COMDAT = 1879048187, 
	SHT_SUNW_syminfo = 1879048188, 
	SHT_GNU_verdef = 1879048189, /* Version definition section.  */
	SHT_GNU_verneed = 1879048190, /* Version needs section.  */
	SHT_GNU_versym = 1879048191, /* Version symbol table.  */
	SHT_HISUNW = 1879048191, /* Sun-specific high bound.  */
	SHT_HIOS = 1879048191, /* End OS-specific type */
	SHT_LOPROC = 1879048192, /* Start of processor-specific */
	SHT_HIPROC = 2147483647, /* End of processor-specific */
	SHT_LOUSER = 2147483648, /* Start of application-specific */
	SHT_HIUSER = 2415919103, /* End of application-specific */
};
...
enum sh_flags : uint32_t
{
	...
	SHF_MASKOS = 267386880, /* OS-specific.  */
	SHF_MASKPROC = 4026531840, /* Processor-specific */
	SHF_ORDERED = (1 << 30), /* Special ordering requirement
					   (Solaris).  */
	SHF_EXCLUDE = (1U << 31), /* Section is excluded unless
...
typedef struct
{
  ...
  enum sh_type	sh_type;		/* Section type */
  enum sh_flags	sh_flags;		/* Section flags */
...
enum p_type : uint32_t
{
	...
	PT_LOOS = 1610612736, /* Start of OS-specific */
	PT_GNU_EH_FRAME = 1685382480, /* GCC .eh_frame_hdr segment */
	PT_GNU_STACK = 1685382481, /* Indicates stack executability */
	PT_GNU_RELRO = 1685382482, /* Read-only after relocation */
	PT_LOSUNW = 1879048186, 
	PT_SUNWBSS = 1879048186, /* Sun Specific segment */
	PT_SUNWSTACK = 1879048187, /* Stack segment */
	PT_HISUNW = 1879048191, 
	PT_HIOS = 1879048191, /* End of OS-specific */
	PT_LOPROC = 1879048192, /* Start of processor-specific */
